...
% error(nargchk(1,Inf,N)) ; 01/10/2017 SBK sick of seeing warning errors
% that nargchk will be removed in future releases so replacing with
% narginchk, also does the nargchk line literally do anything?
